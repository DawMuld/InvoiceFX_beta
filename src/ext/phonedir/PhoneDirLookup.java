            ...
            if (doc != null) {
                ...
                if (businessCards != null && !businessCards.isEmpty()) {
                    ...
                    Debug.out("No Business-card elements returned\n"
                            + "The server has probably detected the ROBOT\n"
                            + "Please Try again later today.\n"
                            + "If this problem is not resolved by time, please contact your local distributor\n"
                            + "Our appologies for the inconvenience...\n... and for the way we spell inconvenience");
                }
            } else {
